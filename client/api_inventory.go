...
/*
InventoryApiService Get product
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InventoryApiService) GetStockResource(ctx context.Context, localVarOptionals *InventoryApiGetStockResourceOpts) (Inventory, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.IncludeCustom.IsSet() {
		localVarQueryParams.Add("include_custom", parameterToString(localVarOptionals.IncludeCustom.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.BondingSupport.IsSet() {
		localVarQueryParams.Add("bonding_support", parameterToString(localVarOptionals.BondingSupport.Value(), ""))
	}
