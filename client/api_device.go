...
/*
DeviceApiService Get by payment method
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param billingInfoId
 * @param optional nil or *DeviceApiGetDevicePaymentMethodLinkedResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *DeviceApiService) GetDevicePaymentMethodLinkedResource(ctx context.Context, billingInfoId int32, localVarOptionals *DeviceApiGetDevicePaymentMethodLinkedResourceOpts) ([]DeviceDump, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/device/linked-payment-method/{billingInfoId}"
