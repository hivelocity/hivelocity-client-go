...
// ServiceDump struct for ServiceDump
type ServiceDump struct {
	...
	ServiceDevices           []map[string]interface{} `json:"serviceDevices,omitempty"`
	ChildServices            []map[string]interface{} `json:"childServices,omitempty"`
