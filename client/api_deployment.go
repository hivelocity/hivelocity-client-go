...
*/
func (a *DeploymentApiService) GetDeploymentIdResource(ctx context.Context, deploymentId int32) (*http.Response, error) {
	var (
...
*/
func (a *DeploymentApiService) GetDeploymentResource(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DeploymentApiService Input a billing info id to process and finish a deployment
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deploymentId Id of the deployment to interact with
 * @param payload
...
func (a *DeploymentApiService) PostDeploymentResource(ctx context.Context, localVarOptionals *DeploymentApiPostDeploymentResourceOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DeploymentApiService) PutDeploymentIdResource(ctx context.Context, deploymentId int32, payload DeploymentCustomization) (*http.Response, error) {
	var (
