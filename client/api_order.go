...
*/
func (a *OrderApiService) GetOrderIdResource(ctx context.Context, orderId int32) (*http.Response, error) {
	var (
...
*/
func (a *OrderApiService) GetOrderResource(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
