...
/*
MaintenanceApiService Get all Maintenance Events for a client
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MaintenanceApiGetMaintenanceEventClientResourceOpts - Optional Parameters:
...
func (a *MaintenanceApiService) GetMaintenanceEventClientResource(ctx context.Context, localVarOptionals *MaintenanceApiGetMaintenanceEventClientResourceOpts) ([]MaintenanceEvent, *http.Response, error) {
	var (
		...
		localVarReturnValue []MaintenanceEvent
	)
...
/*
MaintenanceApiService Get Maintenance Events
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param maintenanceEventId
 * @param optional nil or *MaintenanceApiGetMaintenanceEventIdClientResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *MaintenanceApiService) GetMaintenanceEventIdClientResource(ctx context.Context, maintenanceEventId int32, localVarOptionals *MaintenanceApiGetMaintenanceEventIdClientResourceOpts) (MaintenanceEvent, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/maintenance/{maintenanceEventId}"
	localVarPath = strings.Replace(localVarPath, "{"+"maintenanceEventId"+"}", fmt.Sprintf("%v", maintenanceEventId), -1)
