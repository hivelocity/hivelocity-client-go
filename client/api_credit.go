...
/*
CreditApiService Apply the coupon code for a service
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *CreditApiPostCreditApplyCouponResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *CreditApiService) PostCreditApplyCouponResource(ctx context.Context, payload CartCoupon, localVarOptionals *CreditApiPostCreditApplyCouponResourceOpts) (Credit, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/credit/apply-coupon"
...
/*
CreditApiService Validate the coupon code for a service
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *CreditApiPostCreditValidateCouponResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask

@return ValidateCartCouponDump
*/
...
func (a *CreditApiService) PostCreditValidateCouponResource(ctx context.Context, payload CartCoupon, localVarOptionals *CreditApiPostCreditValidateCouponResourceOpts) (ValidateCartCouponDump, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ValidateCartCouponDump
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/credit/validate-coupon"
