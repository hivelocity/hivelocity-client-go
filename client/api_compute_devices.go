...
func (a *ComputeDevicesApiService) DeleteBareMetalDeviceIdResource(ctx context.Context, deviceId int32) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/compute/{deviceId}"
...
/*
ComputeDevicesApiService Get device
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deviceId
 * @param optional nil or *ComputeDevicesApiGetBareMetalDeviceIdResourceOpts - Optional Parameters:
...
/*
ComputeDevicesApiService Get all devices
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ComputeDevicesApiGetBareMetalDeviceResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *ComputeDevicesApiService) GetBareMetalDeviceResource(ctx context.Context, localVarOptionals *ComputeDevicesApiGetBareMetalDeviceResourceOpts) ([]BareMetalDevice, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/compute/"
...
/*
ComputeDevicesApiService Batch provision instant devices
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *ComputeDevicesApiPostBareMetalDeviceBatchResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *ComputeDevicesApiService) PostBareMetalDeviceBatchResource(ctx context.Context, payload BareMetalDeviceBatchCreate, localVarOptionals *ComputeDevicesApiPostBareMetalDeviceBatchResourceOpts) (BareMetalDeviceBatch, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/compute/batch"
...
/*
ComputeDevicesApiService Provision an instant device
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *ComputeDevicesApiPostBareMetalDeviceResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
/*
ComputeDevicesApiService Update/reload instant device
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deviceId
 * @param payload
 * @param optional nil or *ComputeDevicesApiPutBareMetalDeviceIdResourceOpts - Optional Parameters:
