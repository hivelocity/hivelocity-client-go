...
/*
InvoiceApiService Return total balance of all unpaid invoices
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *InvoiceApiGetInvoiceUnpaidResourceOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
/*
InvoiceApiService Apply account credit to an invoice
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param invoiceId Invoice database ID
 * @param optional nil or *InvoiceApiPostInvoiceIdApplyAccountCreditOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask
...
func (a *InvoiceApiService) PostInvoiceIdApplyAccountCredit(ctx context.Context, invoiceId int32, localVarOptionals *InvoiceApiPostInvoiceIdApplyAccountCreditOpts) (Invoice, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/invoice/{invoiceId}/apply-account-credit"
	localVarPath = strings.Replace(localVarPath, "{"+"invoiceId"+"}", fmt.Sprintf("%v", invoiceId), -1)
